...
?>
   ...
   alert("Veuillez saisir une ville d'arriv�e svp");
   document.formulaire.ville2.focus();
   return false;
  
  }
   else if(document.formulaire.ville1.value == document.formulaire.ville2.value) {
   alert("Vous avez saisi la meme ville pour le d�part et l'arriv�e !");
   document.formulaire.ville2.focus();
   return false;
   ...
   alert("Svp, veuillez saisir votre heure de depart au format hh:mm \n \n exemple: �crire 06:30 pour un trajet � 6h30 \n \n note: vous pouvez �galement saisir \"variable\" ");
   document.formulaire.heure.focus();
   return false;
	}
  ...
  <tr>
   ...
   <td width="240" height="24"><div align="right">Type de trajet: </div>
    ...
    <td width="100">
		...
		<INPUT type="radio" name="type_trajet" value="r�gulier" 
		
		<?php 
		if ($type_trajet == "r�gulier" OR $type_trajet == "") {
			echo "checked"; 
		}
		?>
		onclick="document.location.href='index.php?add_trajet&ponct=2'"> R�gulier </br>
