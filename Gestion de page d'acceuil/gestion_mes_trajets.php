...
<?php
	...
	$i=0;
		while ($donnees = mysql_fetch_array($reponse) ) {
			...
			echo "<TD><div align=\"center\"><a href =\"index.php?supprimer_trajet&num_trajet=$num_trajet\" onclick=\"return(confirm('Etes-vous s�r de vouloir supprimer ce trajet?'));\"><img src='images/adminicons/delete.png' width='24' height='24' border='0'></a></div></TD>";
			echo "</TR>";
