...
<li><a href="javascript:document.location.href='index.php?gestion_mes_reservations'">G&eacute;rer mes réservations </a></li>
<?php
}
?>
...
<?php
	  		...
	  		if (isset($_SESSION['loginOK'])) {
				...
				$reponse = pg_query_params($connexion, "SELECT COUNT(*) AS nbre_entrees FROM trajets WHERE id_conducteur=$1", array($id_sess));
				$compt = pg_fetch_array($reponse);	
        	...
        	<div class="left_box">
                ...
                <div class="center_left_box">
                    ...
                    <div class="form_row">
                        ...
                        Email: mohamed1482001@gmail.com<br />
                        Telephone: 07 79 56 03 19<br />
                        Mobile:      07 79 56 03 19<br />
                        Fax:         34534 3456 3456(31)<br /><br />
                        
                        <span>www.stri.fr</span>
                        </div>
                    </div>                    
                    </div>
...
if(isset($_GET['gestion_mes_reservations'])){ ?>	
        ...
        <div class="title">Gestion de mes r�servations </div> 
		<?php
...
<div class="column4">
    ...
    <form action="index.php" method="post">
		...
		<SELECT name="ville1">		
			...
			<OPTION <?php if ($ville1 == "Toulouse") {echo"selected";} ?> VALUE="Toulouse">Toulouse</OPTION>
			<OPTION <?php if ($ville1 == "Paris") {echo"selected";} ?> VALUE="Paris">Paris</OPTION>
			<OPTION <?php if ($ville1 == "Marseille") {echo"selected";} ?> VALUE="Marseille">Marseille</OPTION>
			<OPTION <?php if ($ville1 == "Bordeaux") {echo"selected";} ?> VALUE="Bordeaux">Bordeaux</OPTION>
			<OPTION <?php if ($ville1 == "Lyon") {echo"selected";} ?> VALUE="Lyon">Lyon</OPTION>
			<OPTION <?php if ($ville1 == "Nante") {echo"selected";} ?> VALUE="Nante">Nante</OPTION>
			<OPTION <?php if ($ville1 == "Valencienne") {echo"selected";} ?> VALUE="Valencienne">Valencienne</OPTION>
			<OPTION <?php if ($ville1 == "Nice") {echo"selected";} ?> VALUE="Nice">Nice</OPTION>
			<OPTION <?php if ($ville1 == "Limoge") {echo"selected";} ?> VALUE="Limoge">Limoge</OPTION>
		</SELECT>
		...
		<SELECT name="ville2">		
			...
			<OPTION <?php if ($ville2 == "Toulouse") {echo"selected";} ?> VALUE="Toulouse">Toulouse</OPTION>
			<OPTION <?php if ($ville2 == "Paris") {echo"selected";} ?> VALUE="Paris">Paris</OPTION>
			<OPTION <?php if ($ville2 == "Marseille") {echo"selected";} ?> VALUE="Marseille">Marseille</OPTION>
			<OPTION <?php if ($ville2 == "Bordeaux") {echo"selected";} ?> VALUE="Bordeaux">Bordeaux</OPTION>
			<OPTION <?php if ($ville2 == "Lyon") {echo"selected";} ?> VALUE="Lyon">Lyon</OPTION>
			<OPTION <?php if ($ville2 == "Nante") {echo"selected";} ?> VALUE="Nante">Nante</OPTION>
			<OPTION <?php if ($ville2 == "Valencienne") {echo"selected";} ?> VALUE="Valencienne">Valencienne</OPTION>
			<OPTION <?php if ($ville2 == "Nice") {echo"selected";} ?> VALUE="Nice">Nice</OPTION>
			<OPTION <?php if ($ville2 == "Limoge") {echo"selected";} ?> VALUE="Limoge">Limoge</OPTION>
		</SELECT>
...
<div id="footer">
	...
	<div id="copyright">
    <div style="float:left; padding:3px;"><a href="#"><img src="images/STRI-logo1.png" width="100" height="35" alt="" title="" border="0" /></a></div>
    <div style="float:left; padding:14px 10px 10px 10px;"> UPSSITECH .&copy; All Rights Reserved 2008 - By <a href="http://stri.fr" style="color:#772c17;">Slama Mohamed</a></div>
    </div>
